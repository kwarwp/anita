...
class Jogo:
    def __init__(self):
        ...
        talita = Elemento (img =linkdatalita, tit="talita", style=dict (left=300,top=50,width=60,height=50))
        colete = Elemento (img= linkdocolete, tit="colete", style=dict (left=50,top=250,width=50,height=200))
        barbie = Elemento (img= linkdabarbie, tit="barbie",  style=dict (left=50,top=250,width=50,height=200))
    ...
    #Jogo()
       ...
       quadro1= Elemento(img= "linkquadro1", tit="quadro1", style= dict(left=120, top=40, heigth=60))
